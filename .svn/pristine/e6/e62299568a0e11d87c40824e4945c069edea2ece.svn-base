            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class=" breadcrumb mtop5 pull-left">
                       <li>
                           <a href="DashboardNoDust"><i class="icon-home"></i></a><span class="divider-last">&nbsp;</span>
                       </li>
                         
                       
                     <!--  <li><a href="#"><spring:message code="Home"/></a><span class="divider-last">&nbsp;</span></li> -->
                  </ul>
            <!--     
                  ...
                  <div class="span12">
                     ...
                     <div class="widget">
                        <div class="widget-title">
                           <h4><spring:message code="Home"/></h4>
                        </div>
                        
						<div class="widget-body">
						<div class="row-fluid" style="height:500px;">
						<div >
						<img alt="" src="resources/assetsnodust/img/Misr-No-Dust-Egypt-20080-1508752714-og (1).jpg" style="height:300px; margin-left:300px;  margin-top:100px;" >
                       </div>
                        </div>
