...
public class CreateDirtyShipmentServiceImpl implements CreateDirtyShipmentService {
	...
	public List<DirtyProductData> Get_Untreated_Product(int shipment_id) {
		// TODO Auto-generated method stub
		return creatDirtyDoa.Get_Untreated_Product(shipment_id);
	}

	@Override
	public List<Consumable> GetTreatmentConsumables(int order_id) {
		// TODO Auto-generated method stub
		return creatDirtyDoa.GetTreatmentConsumables(order_id);
	}

	@Override
	public int Check_Destination_type_id(int shipment_id) {
		// TODO Auto-generated method stub
		return creatDirtyDoa.Check_Destination_type_id(shipment_id);
	}
	...
	public String submitExternalShipment_(String driver, String user, String Lundry, String Products, int cat,
			String Source) {
		// TODO Auto-generated method stub
		return creatDirtyDoa.submitExternalShipment_(driver, user, Lundry, Products, cat, Source);
	}

	@Override
	public int Check_Source_type_id(int shipment_id) {
		// TODO Auto-generated method stub
		return creatDirtyDoa.Check_Source_type_id(shipment_id);
	}
