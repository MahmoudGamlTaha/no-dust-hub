...
public class ReportDAOImpl implements ReportDAO {
	...
	public List<ShipmentType> getShipmentTypes() {
		return sessionFactory.getCurrentSession().createQuery("from ShipmentType where shipment_type_id in (1,2,5,9,6)")
				.list();
	}
	...
	public ReportShipment getShipmentByID(int ship_id) {
		List<ReportShipment>shipments=sessionFactory.getCurrentSession().createSQLQuery(" select\r\n" + 
				...
				"        foo.source_type,\r\n" + 
				"        concat(user1.display_name,',',user1.user_name) as agent,\r\n" + 
				"        concat(user2.display_name,',',user2.user_name) as manager,\r\n" + 
				"        source_.name as source,\r\n" + 
				"        source_2.name as destination  \r\n" + 
				"    from\r\n" + 
				"        (SELECT\r\n" + 
				"            CAST(ship.id AS VARCHAR)as shipment_id ,\r\n" + 
				"            ship.shipment_expected_delivery_date as shipment_date,\r\n" + 
				"            ship.shipment_type_id,\r\n" + 
				"            dr.full_name_en as driver ,\r\n" + 
				"            log2.logged_user as agent,\r\n" + 
				"            log.logged_user as manager ,\r\n" + 
				"            ship.shipment_destination_type_id as destination_type ,\r\n" + 
				"            shipment_source_type_id as source_type,\r\n" + 
				"            ship.shippment_destination_id,\r\n" + 
				"            ship.shippment_souce_id   \r\n" + 
				"        FROM\r\n" + 
				"            shippments ship \r\n" + 
				"           left join  drivers_data dr on  CASE ship.shipment_type_id        \r\n" + 
				"                WHEN 1     THEN dr.user_name = ship.shippment_destination_id     \r\n" + 
				"                WHEN 2    THEN dr.user_name = ship.shippment_souce_id     \r\n" + 
				"                WHEN 5     then dr.user_name = ship.courrier_id          \r\n" + 
				"                when 9    then dr.user_name = ship.courrier_id    \r\n" + 
				"                else    null    \r\n" + 
				"            END   \r\n" + 
				"          left join   shipments_logs log on  log.log_id=(\r\n" + 
				"                select\r\n" + 
				"                    max(log_id) \r\n" + 
				"                from\r\n" + 
				"                    shipments_logs \r\n" + 
				...
				"                    shipment_id=ship.id\r\n" + 
				"            )  \r\n" + 
				"           left join  shipments_logs log2   on log2.log_id=(\r\n" + 
				"                select\r\n" + 
				"                    min(log_id) \r\n" + 
				"                from\r\n" + 
				"                    shipments_logs \r\n" + 
				...
				"    LEFT JOIN\r\n" + 
				"        \"v_source_&_destination_of_shipment\" source_          \r\n" + 
				"            ON source_.id = foo.shippment_souce_id          \r\n" + 
				"    LEFT JOIN\r\n" + 
				"        \"v_source_&_destination_of_shipment\" source_2          \r\n" + 
	...
	public List<ReportShipment> getShipmentsByDate(int facility, int ship_type, String from_date, String to_date) {
		List<ReportShipment>shipments=sessionFactory.getCurrentSession().createSQLQuery("SELECT  foo.shipment_id , \r\n" + 
				...
				"						foo.source,\r\n" + 
				"			          foo.type,\r\n" + 
				"					concat(sc_users1.display_name,',',sc_users1.user_name) as agent, \r\n" + 
				"					concat(sc_users2.display_name,',',sc_users2.user_name) as manager , \r\n" + 
				...
				"						     null\r\n" + 
				"						END \r\n" + 
				"					  left join shipments_logs log on log.log_id=(select max(log_id) from shipments_logs where shipment_id=ship.id)\r\n" + 
				"					left join   shipments_logs log2 on  log2.log_id=(select min(log_id) from shipments_logs where shipment_id=ship.id)\r\n" + 
				"					left join  \"v_source_&_destination_of_shipment\" facility1 on ship.shippment_souce_id = facility1.id\r\n" + 
				"					left join  \"v_source_&_destination_of_shipment\" facility2 on ship.shippment_destination_id = facility2.id \r\n" + 
				"					left join  products_type pt on pt.id= (\r\n" + 
				"									select\r\n" + 
				"										pr.type \r\n" + 
				"									from \r\n" + 
				"										products pr ,\r\n" + 
				...
				"								)\r\n" + 
				"					where  \r\n" + 
				"				  ship.shipment_type_id = "+ship_type+"\r\n" + 
				"				 ) as foo \r\n" + 
				...
				"					ORDER BY foo.shipment_id DESC" ).setResultTransformer(Transformers.aliasToBean(ReportShipment.class)).list();
		if (!shipments.isEmpty())
				return shipments;
		else 
			return null;
	...
	public List<Order> getOrdersByFacility(int facility ,String type , String from_date ,String to_date ) {
		List<Order> orders =sessionFactory.getCurrentSession().createSQLQuery(" SELECT\r\n" + 
				"        foo.id,\r\n" + 
				"        foo.order_type,\r\n" + 
				"        foo.order_source_id,\r\n" + 
				"        foo.order_status,\r\n" + 
				...
				"        foo.from_type,\r\n" + 
				"        foo.to_type,\r\n" + 
				"        concat(user1.display_name,',',user1.user_name) as logged_user,\r\n" + 
				"        concat(user2.display_name,',',user2.user_name) as approved_by \r\n" + 
				"    FROM\r\n" + 
				"        (SELECT\r\n" + 
				"            orders_.id,\r\n" + 
				"            order_type ,\r\n" + 
				"            orders_.order_source_id ,\r\n" + 
				"            status.status_name as order_status,\r\n" + 
				"            orders_.logged_user,\r\n" + 
				"            to_date(to_char(orders_.order_time,\r\n" + 
				"            'yyyy-mm-dd'),\r\n" + 
				"            'yyyy-mm-dd') as order_time,\r\n" + 
				"            orders_.approved_by,\r\n" + 
				"            orders_.from_type,\r\n" + 
				"            types.type as to_type    \r\n" + 
				"        FROM\r\n" + 
				"            orders orders_ \r\n" + 
				"           left join  orders_status status on status.status_id = orders_.order_status_id \r\n" + 
				"           left join  products_type types   on    types.id = orders_.to_type\r\n" + 
				"        where\r\n" + 
				"            \r\n" + 
				"            orders_.order_source_id = "+facility+" \r\n" + 
				...
				"    ORDER BY\r\n" + 
				"        id" ).setResultTransformer(Transformers.aliasToBean(Order.class)).list();
	...
	public List<InventoryCheck> getinventoryChecks(int facility, String from_date, String to_date) {
		List<InventoryCheck> checks =sessionFactory.getCurrentSession().createSQLQuery("SELECT   foo.id,\r\n" + 
				...
				"		foo.facility_id,\r\n" + 
				"		concat(user1.display_name,',',user1.user_name) as logged_user,\r\n" + 
				"		concat(user2.display_name,',',user2.user_name) as warehouse_manager\r\n"+
	...
	public Order getOrderByID(int order_id) {
		List<Order> orders =sessionFactory.getCurrentSession().createSQLQuery("  select foo.id,\r\n" + 
				...
				"					FROM orders orders_  \r\n" + 
				"						 left join products_type types2 on types2.id = orders_.to_type\r\n" + 
				"						 left join orders_status status  on status.status_id = orders_.order_status_id\r\n" + 
				"					where \r\n" + 
				"					\r\n" + 
				"				   orders_.id ="+order_id+") as foo \r\n" + 
				"								LEFT JOIN sc_users user1 \r\n" + 
				"								ON user1.user_name =foo.logged_user \r\n" + 
				"								LEFT JOIN sc_users user2  \r\n" + 
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<CashReconciliationReport> Get_Reconciliation_Transaction(int facility_id) {
		// TODO Auto-generated method stub
		return (List<CashReconciliationReport>)sessionFactory.getCurrentSession().createSQLQuery("select to_char(cr.transaction_date,'dd/MM/yyyy') transaction_date, concat(cr.driver_name,' , ',cr.driver_id) driver_name , CAST(cr.expected_money AS double precision) expected_money , CAST(cr.reconciled_money AS double precision) reconciled_money , CAST(cr.actual_money AS double precision) actual_money \r\n" + 
				", concat(cr.agent_name,',',cr.agent_user_name) as agent_name ,st1.status_name from_status , st2.status_name to_status\r\n" + 
				"from cash_reconciliation_transaction cr \r\n" + 
				"left join shipment_status st1 on CAST(st1.status_id AS text)=cr.from_status_id \r\n" + 
				"left join shipment_status st2 on cast(st2.status_id as text)=cr.to_status_id\r\n" + 
				"where cr.facility_id='"+facility_id+"' and cr.transaction_date=current_date\r\n" + 
				"order by cr.transaction_date desc").setResultTransformer(Transformers.aliasToBean(CashReconciliationReport.class)).list();
	}
	...
	public List<CashReconciliationReport> Get_ReconciliationsInDuration(int fac_id, String from_date, String to_date) {
		...
		return (List<CashReconciliationReport>)sessionFactory.getCurrentSession().createSQLQuery("select to_char(cr.transaction_date,'dd/MM/yyyy') transaction_date, concat(cr.driver_name,' , ',cr.driver_id) driver_name , CAST(cr.expected_money AS double precision) expected_money , cast(cr.reconciled_money as double precision) reconciled_money, cast(cr.actual_money as double precision) actual_money \r\n" + 
				...
				"left join shipment_status st1 on CAST(st1.status_id AS text)=cr.from_status_id \r\n" + 
				"left join shipment_status st2 on cast(st2.status_id as text)=cr.to_status_id\r\n" + 
				"where cr.facility_id='"+fac_id+"' and cr.transaction_date>='"+from_date+"' and cr.transaction_date<='"+to_date+"'\r\n" + 
				"order by cr.transaction_date desc").setResultTransformer(Transformers.aliasToBean(CashReconciliationReport.class)).list();
	}
