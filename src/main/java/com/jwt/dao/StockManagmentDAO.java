...
public interface StockManagmentDAO {
	...
	public List<ProductTransaction>gettransactiondata(int facility_id , String dms_product_id , String date_from , String date_to);
public List<ProductTransaction>getProductsWithTypes(int facility_id , String dms_product_id , String date_from , String date_to);
public List<ProductTransaction>getDataWithDate(int facility_id , String dms_product_id , String date_transaction);
public List<ProductTransaction>getDetailsWithDate(int facility_id,String dms_product_id,String date_transaction);
