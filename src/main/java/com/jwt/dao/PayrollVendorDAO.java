...
public interface PayrollVendorDAO {
	public FinancialAccount GetPayrollAccount(int fac_id);
	public List<PayrollPayment> getPayrollPayment();
	public String submitPayroll(int facility , String   user_name ,  double total , String  payments ,int collect_by_self,String collected_by);
	...
	public List<Payment>Get_PAyment_List_To_Approve(int payment_type,int payment_loc,String due_date,String cash_account);
	...
	public List<Payment>Get_PAyment_List_To_Pay(int payment_type,int payment_loc,String due_date,String cash_account,String emp_id);
