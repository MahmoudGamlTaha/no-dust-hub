...
<head>
   ...
   <title> <spring:message code="Inventory.productList.PageTitle"/></title>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul id="links"class=" breadcrumb mtop5 pull-left">
                       ...
                       <li>
                           <a href="MyProducts"><spring:message code="Inventory.productList.PageTitle"/><span class="divider">&nbsp;</span></a>
                       </li>
                  ...
                  <div class="span12">
                     ...
                     <div class="widget">
                        ...
                        <div class="widget-title" >
                           <h4 id="titlepage"><spring:message code="Inventory.productList.PageTitle"/></h4>
...
<div class="widget-title">
                      ...
                      <div class="space10"></div>
                            <div style="float:left;" >
                              <h5 ><strong style="margin-left:10px; margin-right: 10px;"><spring:message code="warehousename"/></strong> </h5>
                              

</div>
                              <h5 id="warehouse_val" ></h5>
                              <div id="select_div" style="margin-top:5px;">
                              
							  <select id="warehouseSelect" onchange="clearDiv()" class= "js-example-basic-multiple" style="margin-left:10px; width: max-content;">
						...
						<div id="space_div" class="space10"></div>
							<table id="example" style="margin-left: 14px; margin:auto; width:80%;" class="table dataTable table-striped table-bordered table-advance table-hover table-responsive" >
						        <thead>
									...
									<th id="p_id" class="proId"><spring:message code="ProductID"/></th>
						        ...
						        <c:forEach var="product"  items="${productLst}" varStatus="loop">
						                   <tr>
						                    ...
						                    <td id="p_id" class="proId">${product.product_id}</td>
 ...
 <!-- Open & close MENU -->
  ...
  function printFun() {
	  ...
	  var hours=today.getHours();
	   ...
	   var warehouse_var=document.getElementById("warehouseSelect");
	   var warehouse_name=warehouse_var.options[warehouse_var.selectedIndex].text;
	   document.getElementById("warehouse_val").innerText=warehouse_name;
