                    ...
                    <div class="space10"></div>
                          ...
                          <th><spring:message code="PaidAmount"/></th>
                           ...
                           ${payment.unpaid_amount }
                            ...
                            <c:if test="${det.cash_account==payment.cash_account}">
                            <tr>
                            <td>${det.payment_name}</td>
                            <td>${det.payment_type }</td>
                            <td><c:if test="${det.emp_name!=','}">${det.emp_name}</c:if></td>
                            <td><c:if test="${det.total_amount==null}">0</c:if>
                            
                            <c:if test="${det.total_amount!=null}">${det.total_amount}
                            </c:if>
                            </td>
                            <td>
                            ${det.approved }
