...
<head>
   ...
   <title><spring:message code="order_report_detail"/></title>
               ...
               <div class="span12">
                  ...
                  <ul id="links" class=" breadcrumb mtop5 pull-left">
                      ...
                      <li><a href="ShipmentsReport"><spring:message code="ShipmentReport"/></a> <span class="divider">&nbsp; &nbsp;</span></li>
                       <li><a href="OrderReportDetails?OrderID=${order.id}"> <spring:message code="order_report_detail"/></a><span class="divider-last">&nbsp;</span></li>
...
<div class="widget-title" >
						 ...
						 <div id="creatproduct">
						 <table id="creatproduct_" class=" table table-striped table-bordered table-advance table-hover table-responsive " style="max-width: 100%;width:fit-content; margin: auto;min-width: 50%;">
						        <thead>
						            <tr>
			      ...
			      <table id="orderDetail" class="table table-striped table-bordered table-advance table-hover table-responsive " style="max-width: 100%;width: fit-content; margin: auto;min-width: 50%">
						        <thead>
						            <tr>
						            <th>
						            <c:if test="${order.order_type=='5'}">
						            <spring:message code="productComponent"/>
						            </c:if>
 ...
 <!-- Open & close MENU -->
   ...
   <script>
      ...
      $(document).ready(function() {
    	  ...
    	  if ('${order.order_type}'== "2"||'${order.order_type}'== "5"||'${order.order_type}'=="6")
    		  {
    		  $(".conversion_new").hide()
    	  ...
    	  if ('${order.order_type}' != "2"||'${order.order_type}'!="6")
    		  {
    		  $(".comment_").hide()
    		  }
    	    ...
    	    var rows=document.getElementById("orderDetail").rows;
          	...
          	for(var x=0;x<rows.length;x++)
          		...
          		for(var i=0;i<columnLenght;i++)
          			...
          			{}
          			else if(('${order.order_type}'=="6")&&(i==1||i==3||i==4||i==5))
          				{}
          			else	
