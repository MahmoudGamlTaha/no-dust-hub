...
<head>
   ...
   <title> <spring:message code="ProductWashing"/></title>
               ...
               <div class="span12">
                  ...
                  <ul id="links"class=" breadcrumb mtop5 pull-left">
                       <li>
                         ...
                         <li>
                           <a href="InternalDirtyShipment"><spring:message code="CreateInternalDirtyShipment.PageTitle" /> </a><span class="divider-last">&nbsp; &nbsp;</span>
                       </li>
...
<div class="row-fluid invoice-list" style="border:outset;">
                            ...
                            <datalist  id="times" style="display:none;">
                            	 ...
                            	 <div class="span6" id="man_from">
                            	  <div style="float: left; margin-right: 5px;" > <h5 style="display: inline-block;"><strong><spring:message code="ConvertFrom"/></strong></h5>  <span id="astr"> * </span> </div>
                                                                	 <h5 id="from_value"></h5>
                            	 ...
                            	 <div class="span6" id="man_to">
                            	   <div style="float: left; " > <h5 style="display: inline-block;"><strong><spring:message code="ConvertTo" /></strong></h5>      <span id="astr"> * </span>                         
                            	   </div>
                            	                 <h5 id="to_value"></h5>
                               ...
                               <button type="button" id="next_btn" onclick="Check_from_to()" style="margin-right:15px;" class="btn btn-success pull-right green mright5"><i class="icon-save icon-white"></i> <spring:message code="Next"/></button>
                                ...
                                <table id="example" class="table table-striped table-bordered   table-advance table-hover table-responsive " style="width:90%; margin:auto;">
                                    ...
                                    <tr class="odd gradeX ">
                                      <td class="first" ><input type='checkbox' name='record' disabled="disabled"></td>
                                        ...
                                        <td><input required="required"  onchange="changeQuentity(this)" type="number" class="span6" /></td>
    ...
    <input id="program_data" style="display:none;"/>
                 ...
                 <strong> <spring:message code="ConsumableDetails"/> </strong>
                  <table id="details_tbl" class="table table-striped table-bordered   table-advance table-hover table-responsive " style="width:80%; margin:auto;">
                  <thead>
                  <tr>
                  <th><spring:message code="WashingProgram"/></th>
   ...
   <script>
      ...
      function changingproduct(e) {
          ...
          myTable.rows[rowIndex].cells[10].innerHTML = e.options[e.selectedIndex].text;
      ...
      {
    	  var tbl_body="";
    	  $("#total_tbl tbody").html(tbl_body);
    	  $("#details_tbl tbody").html(tbl_body);
