...
<head>
   ...
   <title> <spring:message code="RecieveUntreatedProducts.PageTitle"/></title>
               ...
               <div class="span12">
                  ...
                  <ul id="links"class=" breadcrumb mtop5 pull-left">
                       <li>
                         ...
                         <li>
                           <a href="ReceiveUntreatedProducts"><spring:message code="RecieveUntreatedProducts.PageTitle"/> </a><span class="divider-last">&nbsp; &nbsp;</span>
                       </li>
    		 ...
    		 /* $.alert({
    		  ...
    		  var xhttp = new XMLHttpRequest();
    	    	...
    	    	if (this.readyState == 4 && this.status == 200) {
    	    		...
    	    		if(response=="No_Pro")
    	    			{
    	    			swal("<spring:message code="ShipmentList.Error.Title"/>","<spring:message code="NoAvaialableStockInLaundry"/>","error");
    	    			/* $.alert({
    	         	          title: "<spring:message code="ShipmentList.Error.Title"/>",
    	    			...
    	    			var rows="";
    	    			var pr="<select class='productSelect' id='productSelect' onchange='changingproduct(this)'><option value='No_value'><spring:message code="PleaseSelect"/></option>";
    			...
    			upload_attachment(response);
    			  ...
    			  document.getElementById("recieveAttach").disabled = true;
	    			...
	    			$('#tableform  input[type=checkbox]').prop("disabled", true);
	      	    	...
	      	    	swal("<spring:message code="Releasingproduct.CoverList.details.SuccessSubmit.title" />","<spring:message code="ReceiveUntreatedShipmentFromExternalLaundySubmittedSuccessfully" />","success");
/*$.alert({
