...
<div class="row-fluid " style="border:outset;">
                              ...
                              <div class="row-fluid">
                               ...
                               <div class="row-fluid">
                                ...
                                <div style="float:left;width:50%;">
                                    <div > <h5 > <strong><spring:message code="CashAmount"/> </strong>${cash_form.cash_amount} </h5></div>
                                </div>
                       ...
                       <div class="row-fluid  ">
                                     <c:if test="${cash_form.attachment==null}">
                             <button type="button"  id="reattachBtn" style="margin-right: 15px; width:fit-content;" class="btn btn-success pull-right green mright5 " onclick="reattach_bank();"><i class="icon-save  icon-white" style="margin-right: 4px;"></i><spring:message code="Reattach"/></button>   
       </c:if>
