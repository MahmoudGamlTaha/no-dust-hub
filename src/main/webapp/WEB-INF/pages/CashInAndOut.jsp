...
<head>
   ...
   <title> <spring:message code="ReleasingCash.PageTitle"/></title>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul id="links" class=" breadcrumb mtop5 pull-left">
                       ...
                       <li>
                           <a href="DispatchingCash"> <spring:message code="ReleasingCash.PageTitle" /> <span class="divider">&nbsp;</span></a>
                       </li>
...
<div class="row-fluid " style="border:outset;">
                             ...
                             <div style="float:left;width:40%;"> <h5 style="margin-left:5px;"><strong><spring:message code="warehousename" /></strong>
                                ...
                                <div style="float:left;width:50%;">
                                <strong style="margin-left:5px;"><spring:message code="Name"/></strong>
                                ...
                                <div class="span6 invoice-block pull-right">
								 ...
								 <div >
		                              <label class="control-label  span4 " style="text-align:left;"> <strong style="margin-left:5px;"><spring:message code="Attachment"/> <span id="astr" style="padding: 5px;"> * </span></strong></label>
                                       ...
                                       <li>  <strong class="span3">  <spring:message code="Name" /> :<span id="astr" style="padding: 5px;"> * </span></strong> 
                                     <form:select path="selectedDriver" id="selectDriver" class= "span8 js-example-basic-multiple">
								      <option value="NoValue"><spring:message code="PleaseSelect"/></option>
								       <c:forEach items="${formData.lst_drivers_users}" var="driver">
								        <option value="${driver.user_name}"<c:if test="${driver.user_name eq formData.selectedDriver}">selected="selected"</c:if> >${driver.name} , ${driver.user_name}</option>
								     </c:forEach>
                                     ...
                                     <form:select disabled="true" id="accountSelect" path="selected_product_id" onchange="changingAvailable(this)" class= "span8 js-example-basic-multiple">
                                  ...
                                  <li>
                                   <textarea class="span12" required placeholder="Write Comment" id="CashComment" rows="2" ></textarea>
 ...
 <!-- Open & close MENU -->
   ...
   <script>
      	 ...
      	 if(validation != false&&check_driver_val!="NoValue"&&validate_attach!=false&&check_account_val!="No_Value")
      		...
      		submitData()
      		 ...
      		 if(check_driver_val=="NoValue")
      			 {
      			 swal("<spring:message code="ShipmentList.Error.Title"/>","<spring:message code="SelectValidName" />","error");
      			/*$.alert({
	      	    	  title: "Error",
      ...
      function submitData() {
    	  ...
    	  var comment_val=document.getElementById("CashComment").value;
    	  var cashInOutForm ={
    			  "selectedDriver" : driver_val ,
    	...
    	if (this.readyState == 4 && this.status == 200) {
    		...
    		if(response>0)
    			...
    			swal("<spring:message code="ReleasingCash.FailedSubmit.title" />","<spring:message code="ReleasingCash.FailedSubmit.content" />","error");
    		 	/*  $.alert({
