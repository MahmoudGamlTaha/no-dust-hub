...
<head>
   ...
   <title><spring:message code="EXTShipmentList"/></title>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class=" breadcrumb mtop5 pull-left">
                       ...
                       <li><a href="ViewExternalShipments"> <spring:message code="ViewExternalShipments.PageTitle"/></a><span class="divider-last">&nbsp;</span></li>
                  </ul>
