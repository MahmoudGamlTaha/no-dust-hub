...
$(document).ready(function() {
   ...
   .appendTo( '#EmpTable_wrapper .col-md-6:eq(0)' );
...
<jsp:include page="NavBar.jsp">
     ...
     <div class="page-content d-flex align-items-stretch"> 
       <jsp:include page="SideNave.jsp">
         <jsp:param name="param1" value="employeeli"/>
     </jsp:include>
...
<sec:authorize access="hasRole('ROLE_ADMIN')">
  <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modalYT">Start Instance</button>
                  	</sec:authorize>
  ...
  <div class="modal-dialog modal-lg" role="document">
    ...
    <!--/.Content-->
		...
		<table id ="EmpTable" class="table table-striped table-bordered" style="width:80%">
			...
			<th>Email</th>
			<th>Address</th>
			<th width="100" data-breakpoints="xs sm md lg">Telephone</th>
			<th>Action</th>
			</tr>
			</thead>
			<tfoot>
