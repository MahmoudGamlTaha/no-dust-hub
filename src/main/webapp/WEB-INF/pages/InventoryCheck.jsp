...
<head>
   ...
   <title> <spring:message code="InventoryCheck.PageTitle"/></title>
               ...
               <div class="span12">
                  ...
                  <ul id="links"class=" breadcrumb mtop5 pull-left">
                       <li>
                         ...
                         <li>
                           <a href="InventoryCheck"><spring:message code="InventoryCheck.PageTitle"/></a><span class="divider-last">&nbsp; &nbsp;</span>
                       </li>
			   ...
			   <form:form modelAttribute="data" id="inventoryForm" action="CreateInventoryCheck" style="margin-left: 7px;">
                   ...
                   <div>
                       <button type="button" id="submitBtn" onclick="submitForm()"  class="btn btn-warning pull-right  mright5 " style="margin-bottom: 5px; float:right;"><i class="icon-plus icon-white mright5"></i><spring:message code="Create"/></button>
                                ...
                                <table id="tableform" class="table dataTable table-striped table-bordered   table-advance table-hover table-responsive " style="width:80%;">
                                    <thead>
                                    <tr>
                                 ...
                                 <c:forEach var="product" items="${data.products}" varStatus="vs">
	                                    ...
	                                    <form:hidden path="products[${vs.index}].type"/>
	                                    <form:hidden path="products[${vs.index}].type_name"/>
  ...
  //  $('#inventoryForm').on('submit', function(e){
    ...
    */
      ...
      $(document).ready(function() {
    	  ...
    	  //var x=document.getElementById('type_filter').value;
		 // $('#tableform').DataTable().columns().search('Dirty').draw();
      ...
      function submitForm() {
    	  ...
    	  if($("#tableform input:checkbox:checked").length > 0){
    		  ...
    		  $('#tableform').DataTable().columns().search('').draw();
