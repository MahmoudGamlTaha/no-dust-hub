...
<head>
   ...
   <title><spring:message code="ProductsDying"/> </title>
               ...
               <div class="span12">
                  ...
                  <ul id="links"class=" breadcrumb mtop5 pull-left">
                       <li>
                         ...
                         <li>
                           <a href="ProductsDying"><spring:message code="ProductsDying" /> </a><span class="divider-last">&nbsp; &nbsp;</span>
                       </li>
    	...
    	document.getElementById("cancel_btn").disabled = false;
    	 ...
    	 xhttp.send(JSON.stringify(Dying_form));
	    	...
	    	document.getElementById("cancel_btn").disabled = false;
     		 ...
     		 swal("<spring:message code="ShipmentList.Error.Title"/>","<spring:message code="selectvaliddyeingprogram"/>","error");
     		/*$.alert({
		          title: "Error",
