...
<head>
   ...
   <title><spring:message code="ViewCleanShipmentDetails"/></title>
...
<div class="row-fluid invoice-list" style="border:outset;">
                             ...
                             <div class="row-fluid">
                                <div id="warehouse_name_div">
                                    <div> <h5 ><strong><spring:message code="SourceWarehouse" /></strong>
                                     ${shipmentData.warehouse_name} 	</h5></div>
                                </div>
                              ...
                              <div class="clearfix"></div>  
                                ...
                                <div class="row-fluid">
                                 <div > <h5 style="margin-left:5px;"><strong><spring:message code="ProductType_" /> </strong>
                                     ${shipmentData.type} 	</h5></div>
                                
                                </div>
                            <div class="row-fluid">
                                
                            <div id="driver_div">
                                    <div  style="float: left; margin-right: 10px;"> <strong style="display:inline-block; margin-left:5px;"> <spring:message code="Drivername" />
                                  </strong>  <c:if test="${shipmentData.last_status!= '5'}">	<span id="astr"> * </span> </c:if>
                                <h5 id="driver_val"><c:if test="${shipmentData.last_status== '5'}">  ${shipmentData.driver_name} </c:if> </h5> 
                                                                <c:if test="${shipmentData.last_status== '5'}">  <h5 id="driver_val_approved" style="display:inline-block;">${shipmentData.driver_name}  </h5> </c:if>
                                  </div>
                                  <c:if test="${shipmentData.last_status!= '5'}">
                              <div  id="driver_style"> 
                                    	  <select  id="SelectDriver" name="driver" onchange="Check_driver_select()" class= "span6 js-example-basic-multiple" style="width: auto;" >
                                ...
                                <div id="dest" style="float: left;">
                            	 ...
                            	 <div >
                            	             ...
                            	             <div class="span6" style="display:none;" id="div_ver_code" >
                  ...
                  <div class="row-fluid">
                    ...
                    <div >
                 <h5 style="margin-left:5px;"><strong> <spring:message code="ApprovedBy_"/></strong>${approved_by}</h5>
                 </div>
                 </div>
                  <c:if test="${shipmentData.last_status== '5'}">
                 <div >
 ...
 <!-- Open & close MENU -->
   ...
   <script>
      ...
      function print_data(){
    	  ...
    	  var driver_val='${shipmentData.driver_name}';
      ...
      function Check_driver_select()
      {
    	  ...
    	  var driver_id='${shipmentData.driver_id}';
    	  if(val==driver_id)
    		  {
     ...
     function submitForm()
     {
    	 ...
    	 if($("#tableform input:checkbox:checked").length > 0)
    	 {
    		...
    		// var val_code=document.getElementById("verif_code").reportValidity();
    		 ...
    		 if(check_driver!="Please Select"&& validate_quan!=false&& auth_val=="Auth"&&check_auth_done=="done")
    			 {
    		 ...
    		 submitData();
    			...
    			/* $.alert({
    			 ...
    			 else if (document.getElementById("SelectDriver").value=="Please Select")
    				 {
   ...
   //	console.log(table2);
	...
	if (this.readyState == 4 && this.status == 200) {
		...
		if(response == "success")
    	    ...
    	    swal("<spring:message code="Releasingproduct.CoverList.details.SuccessSubmit.title" />","<spring:message code="ReceiveNewShipmentSubmittedSuccessfully" />","success");
    	    /*
  			$.alert({
    	    		
                  title: "<spring:message code="Releasingproduct.CoverList.details.SuccessSubmit.title" />",
      		    content:"<spring:message code="ReceiveNewShipmentSubmittedSuccessfully" />",
                  }); */
    	    	document.getElementById("submitBtn").disabled = true;
