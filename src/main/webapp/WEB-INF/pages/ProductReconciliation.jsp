...
<head>
   ...
   <title> <spring:message code="ProductReconciliation.ProductReconciliation"/></title> 
                  ...
                  <div class="span12">
                     ...
                     <div class="widget">
                        ...
                        <div class="row-fluid invoice-list" style="border:outset;">
                             ...
                             <div class="row-fluid">
                                    ...
                                    <div style="float:left;width:40%;"> <h5 style="margin-left:10px;"><strong> <spring:message code="warehousename" /> </strong>
                                      ${Rec_data.warehouse_name }	</h5></div>
                                    
                                     <div style="float:left; width:30%;"> <h5 ><strong><spring:message code="Agentname" /></strong> 
                                      ${Rec_data.agent_name} 	</h5></div>
                                    
                                     <div style="float:left; width:30%;"> <h5 ><strong><spring:message code="Date" /></strong>
                                      ${date} 	</h5></div>
                                    
                                 <div style="float:left;width:40%;"> <h5 style="margin-left:10px;"><strong><spring:message code="Drivername" /></strong> 
                                     ${Rec_data.driver_name} 	</h5></div>   
                           <div style="float:left;"> <h5 ><strong><spring:message code="areaName" /></strong> 
                                     ${Rec_data.area_name} 	</h5></div>
							...
							<table id="example2" class="table table-striped table-bordered   table-advance  table-responsive " style="width:80%;margin:auto;">
						      <thead>
						       <tr>
	                 ...
	                 -->
                             	     ...
                             	     <div class="space20"></div> 
                             	                               <button type="button" onclick="Submit_Form()" class="btn btn-success pull-right  green mright5" id="submit_btn" style="margin-right:10px;"><i class="icon-save icon-white"></i> <spring:message code="Next"/></button>
                             	     <div class="space10"></div>
